...
当前最高优先级为：方块爆破、麻将三消、宝石消除、割草生存、麻将连连看、排序大师、合成工坊、机关塔防。
...
1. 方块爆破
   ...
   - 当前状态：已接入大厅，包含 60 关闯关、冰块、炸弹、旋转、锤子和换组。

2. Tile 三消麻将
   - 三张同牌入槽消除，槽位限制、锁牌、冰牌、章节地图、道具。
   - 当前状态：已接入大厅，包含 60 关章节、槽位压力、封印牌、冰封牌、暗牌、提示、撤回和洗牌。

3. 割草生存
   - 复用街机引擎，自动攻击、经验升级、技能组合、精英怪、Boss、装备掉落。
   - 当前状态：已接入大厅，包含 60 关怪潮、自动飞刃、灵能环、护身轮、雷链、属性成长、补给掉落和每 5 关 Boss。

4. 排序大师
   - 颜色/螺丝/停车三种规则先做一种，关卡化、步数限制、锁位和撤销道具。
   - 当前状态：已接入颜色瓶排序试点，包含 60 关、锁链瓶、冰封瓶、提示、撤回、钥匙、破冰和洗局。

第二批建议：

1. Merge 合成经营
   - 当前状态：已接入合成工坊试点，包含 60 关订单、生成器、能量、锁箱、封印材料、提示、撤回、钥匙、清扫和换单。
